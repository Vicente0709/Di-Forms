...
Font.register({ family: "Roboto", src: "https://fonts.gstatic.com/s/roboto/v20/KFOmCnqEu92Fr1Mu72xKOzY.woff2", fontWeight: 900, });
                ...
                <View style={styles.tableCol}>
                    ...
                    <Text style={styles.baseText}>
                        ...
                        data.inscripcion === "SI"
                            ? "X"
                            : ""}
                        <Text style={styles.baseText}>{" )  “El pago es realizado por la EOD-UGIPS del VIIV”"}</Text>
                        </Text>
                    </Text>
                    </Text>
                    <Text style={styles.baseText}>
...
export async function generateAnexoAOutsideProject(data, returnDocument = false) {
    const template = {
      schemas: schemasAnexoA,
      basePdf: basePdfAnexoA,
    };
