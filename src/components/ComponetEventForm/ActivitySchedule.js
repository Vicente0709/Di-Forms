...
function ActivitySchedule() {
  ...
  return (
    <div className="form-container">
            ...
            <tr key={field.id}>
              ...
              <td>
                <input
                  ...
                  id={`fecha-${index}`}
                  className="form-input"
                  {...register(`actividades[${index}].fecha`, { required: "Este campo es requerido" })}
                />
                {errors.actividades && errors.actividades[index]?.fecha && (
                  <span className="error-text">{errors.actividades[index].fecha.message}</span>
                )}
              </td>
              <td>
                <input
                  ...
                  className="form-input"
                  {...register(`actividades[${index}].descripcion`, { required: "Este campo es requerido" })}
                  placeholder="Describe la actividad a realizar"
                />
                {errors.actividades && errors.actividades[index]?.descripcion && (
                  <span className="error-text">{errors.actividades[index].descripcion.message}</span>
                )}
              </td>
              <td>
      ...
      <div className="form-container">
      <h3>6.2 Justificar la necesidad de la comisión de servicios mayor a 15 días</h3>
      <p className="instruction-text">
